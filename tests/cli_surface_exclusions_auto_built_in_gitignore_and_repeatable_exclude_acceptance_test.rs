...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_1() {
...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_2() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_3() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_4() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_5() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_6() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
...
#[test]
fn built_in_excluded_directory_under_the_scanned_path_is_never_scanned_example_7() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
...
#[test]
fn gitignore_awareness_silently_no_ops_when_no_git_executable_is_available_example_1() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
    example.insert("right_file".to_string(), "src/beta.rs".to_string());
...
#[test]
fn gitignore_awareness_silently_no_ops_outside_a_git_work_tree_example_1() {
    let mut world = World::new();
    let mut example: HashMap<String, String> = HashMap::new();
    example.insert("left_file".to_string(), "src/alpha.rs".to_string());
    example.insert("right_file".to_string(), "src/beta.rs".to_string());
