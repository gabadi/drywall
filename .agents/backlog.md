...
2026-06-21 | swarmforge-pattern | convention-gap | ux-engineer,coder | pending | swarm-persona Skill tool invoked redundantly when /swarm-persona command already injected content; double-load wastes cache — harness or skill should detect already-loaded state
