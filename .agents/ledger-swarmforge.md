...
2026-06-21 | 54af2c16-77f8-4b04-aba0-9707d2622721 | integrator | wrong-path | rejected→swarmforge | pending | Integrator lifecycle step 4 "git checkout swarmforge-integrator" silently fails in worktree setup; guard: skip if PWD is .worktrees/integrator
2026-06-21 | 54af2c16-77f8-4b04-aba0-9707d2622721 | integrator | wrong-path | rejected→swarmforge | pending | Before drafting handoff referencing post-merge trunk commit, run git fetch origin main in integrator worktree — merged commit may not be in local refs
2026-06-21 | 54af2c16-77f8-4b04-aba0-9707d2622721 | integrator | tool-error | rejected→swarmforge | pending | timeout command not available on macOS (no GNU coreutils); replace timeout 1800 gh pr checks --watch with gh pr checks --watch 2>&1 || true
