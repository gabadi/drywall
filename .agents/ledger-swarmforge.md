...
2026-06-21 | e8291b83-d205-4af2-bd47-d04608d89322 | architect | wrong-path | rejected→swarmforge | pending | When receiving git_handoff, run git diff HEAD <commit> --stat FIRST as ground-truth check; empty diff = no-forward
...
2026-06-21 | 1762020f-4f10-4aaa-bfb8-843752680366 | cleaner | convention-gap | rejected→swarmforge | pending | Handoff pipeline should enforce rebase on downstream cleaner branch before sending upstream — add/add conflicts otherwise
...
2026-06-21 | cd1fedb9-ccf8-4ea9-80a9-f688b5733499 | specifier | convention-gap | rejected→swarmforge | pending | Investigate: specifier git reset --hard origin/<default> routinely denied by sandbox; add guarded form or allow-rule
...
2026-06-21 | 8fbf47f7-c991-464e-8232-c9d7b6c7debb | ux-engineer | convention-gap | rejected→swarmforge | pending | Constitution or role: in autonomous sessions, resolve ambiguities silently and act — do not narrate decision branches inline
