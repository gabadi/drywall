...
2026-06-21 | b4761e12-ce6a-4176-88b1-82541ca6fd67 | architect | convention-gap | rejected→swarmforge | pending | git_handoff commit: always use git rev-parse --short=10 HEAD (10 chars); default --short=7 is wrong
...
2026-06-21 | 8fbf47f7-c991-464e-8232-c9d7b6c7debb | ux-engineer | convention-gap | rejected→swarmforge | pending | Clarify in ux-engineer role: `# UX INTENT: none` comment satisfies "no ## UX Intent section" — pass through to cleaner
